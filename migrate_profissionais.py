...
def migrate_profissionais():
    ...
    try:
        ...
        # 1. Criar tabela profissionais se não existir
        cursor.execute('''
            CREATE TABLE IF NOT EXISTS profissionais (
                ...
                tipo_conta VARCHAR(20) DEFAULT "permanente",
                data_expiracao DATETIME,
                created_at DATETIME DEFAULT CURRENT_TIMESTAMP
            )
        ''')
        
        # 2. Criar tabela de solicitações de cadastro
        cursor.execute('''
        ...
        # 3. Criar tabela de senhas temporárias
        cursor.execute('''

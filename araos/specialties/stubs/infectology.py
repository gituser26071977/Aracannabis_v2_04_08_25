"""
AraOS Specialty — Infectologia (Stub).
...
INFECTOLOGY_DEFINITION = SpecialtyDefinition(
    code="infectology",
    name="Infectologia",
    description="Acompanhamento de doenças infecciosas.",
...
class InfectologyProfile(SpecialtyProfile):
    """Profile especializado para Infectologia."""

    def __init__(self, patient_id: str, tenant_id: str):
        super().__init__(patient_id, tenant_id, specialty_code="infectology")

    def validate(self) -> List[str]:
        return []

    def get_definition(self) -> SpecialtyDefinition:
        return INFECTOLOGY_DEFINITION

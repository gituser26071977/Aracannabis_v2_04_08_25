"""
AraOS Specialty — Nefrologia (Stub).
...
NEPHROLOGY_DEFINITION = SpecialtyDefinition(
    code="nephrology",
    name="Nefrologia",
    description="Acompanhamento renal e função dos rins.",
...
class NephrologyProfile(SpecialtyProfile):
    """Profile especializado para Nefrologia."""

    def __init__(self, patient_id: str, tenant_id: str):
        super().__init__(patient_id, tenant_id, specialty_code="nephrology")

    def validate(self) -> List[str]:
        return []

    def get_definition(self) -> SpecialtyDefinition:
        return NEPHROLOGY_DEFINITION

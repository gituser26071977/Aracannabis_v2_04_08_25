"""
AraOS Specialty — Cardiologia (Stub).
...
CARDIOLOGY_DEFINITION = SpecialtyDefinition(
    code="cardiology",
    name="Cardiologia",
    description="Acompanhamento cardiovascular.",
...
class CardiologyProfile(SpecialtyProfile):
    """Profile especializado para Cardiologia."""

    def __init__(self, patient_id: str, tenant_id: str):
        super().__init__(patient_id, tenant_id, specialty_code="cardiology")

    def validate(self) -> List[str]:
        return []

    def get_definition(self) -> SpecialtyDefinition:
        return CARDIOLOGY_DEFINITION

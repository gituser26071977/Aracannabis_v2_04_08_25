...
clínico do Módulo NEURODESENVOLVIMENTO segundo princípios DDD:
    ...
    - Value Objects: CID10Code, CID11Code, DSM5Code, ConditionCode, DiagnosisClassification

...
def upgrade():
    ...
    op.create_index('ix_convites_profissionais_email', 'REDACTED', ['email'], unique=False)
    op.create_index('ix_convites_profissionais_token', 'REDACTED', ['token'], unique=False)


def downgrade():
    op.drop_index('ix_convites_profissionais_token', table_name='REDACTED')
    op.drop_index('ix_convites_profissionais_email', table_name='REDACTED')

...
class TestLLMProviders:
    ...
    @pytest.mark.asyncio
    async def test_mock_provider_responds_to_medications(self, mock_provider):
        request = LLMRequest(
    ...
    @pytest.mark.asyncio
    async def test_mock_provider_responds_to_allergies(self, mock_provider):
        request = LLMRequest(
...
class TestLLMRuntime:
    ...
    @pytest.mark.asyncio
    async def test_runtime_returns_trusted_response(self, llm_runtime):
        messages = [LLMMessage(role=MessageRole.USER, content="resumo")]
    ...
    @pytest.mark.asyncio
    async def test_runtime_structured_data_does_not_require_verification(self, llm_runtime):
        messages = [LLMMessage(role=MessageRole.USER, content="resumo")]
...
class TestClinicalContextBuilder:
    ...
    @pytest.mark.asyncio
    async def test_builder_creates_context_from_twin(self, env):
    ...
    def test_system_prompt_has_clinical_restrictions(self):
...
class TestObservability:
    ...
    def test_metrics_collector_records_calls(self):
    ...
    def test_llm_runtime_summary_after_calls(self, llm_runtime):

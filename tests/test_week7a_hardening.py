...
class TestP1EventConsumers:
    ...
    @pytest.mark.asyncio
    async def test_consumer_processes_diagnosis_event(self, env):
    ...
    @pytest.mark.asyncio
    async def test_consumer_processes_medication_event(self, env):
    ...
    @pytest.mark.asyncio
    async def test_no_direct_projection_calls_in_fluxo1(self, env):
    ...
    @pytest.mark.asyncio
    async def test_no_direct_projection_calls_in_fluxo3(self, env):
...
class TestP2TwinCache:
    ...
    @pytest.mark.asyncio
    async def test_cache_invalidation_on_clinical_event(self, env):
...
class TestP3Idempotency:
    ...
    @pytest.mark.asyncio
    async def test_tracker_tracks_processed_events(self, env):
...
class TestP4ClinicalRepository:
    ...
    def test_sqlalchemy_repository_uses_session(self, env):
    ...
    @pytest.mark.asyncio
    async def test_twin_builder_uses_repository_not_session(self, env):
...
class TestMetrics:
    ...
    @pytest.mark.asyncio
    async def test_twin_rebuild_faster_with_cache(self, env):
    ...
    @pytest.mark.asyncio
    async def test_fluxo2_completo_com_nova_arquitetura(self, env):
    ...
    @pytest.mark.asyncio
    async def test_fluxo3_completo_com_nova_arquitetura(self, env):

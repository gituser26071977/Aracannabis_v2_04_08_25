...
def app_with_secretaria():
    ...
    app.config["JWT_SECRET_KEY"] = "test-secretaria-dashboard-secret-key-32b"
    app.config["SECRET_KEY"] = "test-secretaria-dashboard-secret-key-32b"
...
class TestDashboard:
    ...
    def test_dashboard_requires_association(self, client, app_with_secretaria):
...
class TestCheckin:
    ...
    def test_checkin_blocked_for_other_tenant(self, client, app_with_secretaria):
...
class TestPacientes:
    ...
    def test_quick_search_short_query_returns_empty(self, client, app_with_secretaria):
        token = _make_token(app_with_secretaria, 10)
        res = client.get(

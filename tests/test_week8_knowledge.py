...
class TestLLMKnowledgeAdapter:
    ...
    def test_retrieve_returns_knowledge_context(self, repo):
        repo.save_document(KnowledgeDocument(
            document_id="doc_001", tenant_id="t1",
            knowledge_type=KnowledgeType.CLINICAL,
            source_type=KnowledgeSourceType.PROTOCOL,
    ...
    def test_retrieve_filters_by_knowledge_type(self, repo):
        repo.save_document(KnowledgeDocument(
            document_id="doc_001", tenant_id="t1",
            knowledge_type=KnowledgeType.CLINICAL,
            source_type=KnowledgeSourceType.PROTOCOL,
    ...
    def test_build_messages_includes_context(self, repo):
        adapter = LLMKnowledgeAdapter(repo)
    ...
    def test_build_messages_without_context(self, repo):
        adapter = LLMKnowledgeAdapter(repo)
...
class TestEmbeddingContracts:
    ...
    @pytest.mark.asyncio
    async def test_mock_embedding_provider_different_texts(self):
        provider = MockEmbeddingProvider(dimension=384)
    ...
    @pytest.mark.asyncio
    async def test_in_memory_embedding_index_with_filters(self):
        index = InMemoryEmbeddingIndex()
    ...
    @pytest.mark.asyncio
    async def test_in_memory_embedding_index_delete(self):
        index = InMemoryEmbeddingIndex()
    ...
    @pytest.mark.asyncio
    async def test_in_memory_embedding_index_health(self):
        index = InMemoryEmbeddingIndex()

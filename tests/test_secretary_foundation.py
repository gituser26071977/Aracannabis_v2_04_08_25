...
class TestValidators:
    ...
    def test_validar_crm_opcional_secretary(self):
    ...
    def test_validar_crm_opcional_profissional(self):
    ...
    def test_validar_crm_opcional_auxiliar_legacy(self):
...
class TestPermissionMiddleware:
    ...
    def test_admin_bypass_returns_all_permissions(self):
    ...
    def test_auxiliar_legacy_normalizes_to_secretary(self):
    ...
    def test_combines_global_and_association_roles(self):
...
class TestRBACDecorators:
    ...
    def test_require_role_secretary_blocks_doctor(self, app_with_secretary):
        client = app_with_secretary.test_client()
    ...
    def test_require_permission_prescription_blocks_secretary(self, app_with_secretary):
    ...
    def test_require_permission_patient_read_allows_secretary(self, app_with_secretary):
    ...
    def test_require_permission_admin_bypass(self, app_with_secretary):
    ...
    def test_require_association_member_secretary_with_header(self, app_with_secretary):
        client = app_with_secretary.test_client()
        token = self._login_token(app_with_secretary, 1)
        res = client.get(
            "/test/assoc-required",
    ...
    def test_require_association_member_admin_bypass(self, app_with_secretary):
        client = app_with_secretary.test_client()
        token = self._login_token(app_with_secretary, 3)
        res = client.get(
            "/test/assoc-required",

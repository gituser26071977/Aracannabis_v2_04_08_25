...
class RegistrationAIVerificationTestCase(unittest.TestCase):
    ...
    def test_verify_registration_auto_approve(self, mock_timing, mock_dup_email, mock_disp_email, mock_dom_email, mock_format_email, mock_dup_crm, mock_format_crm):
    ...
    @patch('services.registration_verification_service.check_duplicate_email')
    @patch('services.registration_verification_service.analyze_registration_timing')
    def test_verify_registration_manual_review(self, mock_timing, mock_dup_email, mock_disp_email, mock_dom_email, mock_format_email, mock_dup_crm, mock_format_crm):

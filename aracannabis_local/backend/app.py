...
# Carregar variáveis do .env ANTES de outras importações
...
def create_app():
    ...
    def index():
        ...
        <body>
            ...
            <p>Para acessar o frontend, abra <a href="http://localhost:3002">http://localhost:3002</a> em seu navegador.</p>
        </body>
        </html>
        '''
    ...
    # Removidos os registros de blueprints de IA
...
if __name__ == '__main__':
    app = create_app()
    port = int(os.environ.get('PORT', 5011))  # Porta diferente para não conflitar

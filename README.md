...
> **Status:** Fase 1.0 — Sprint 0 (Foundation)
> **Constituição:** `docs/AraFlow/32_FINAL_PRODUCT_DECISIONS.md` + `docs/AraFlow/33_ENGINEERING_BLUEPRINT.md`
> **Próximo marco:** Sprint 1 (Timer Engine)

AraFlow é o **módulo de neuroregulação digital** da plataforma AraOS. Aplicativo mobile (iOS + Android) que oferece sessões de respiração guiadas para regulação autonômica (ansiedade, estresse, foco, sono).

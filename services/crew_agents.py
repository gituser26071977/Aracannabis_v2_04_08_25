...
@tool
def consultar_status_estoque_associacao(associacao_id: int) -> Dict:
...
@tool
def gerar_relatorio_completo_associacao(associacao_id: int, periodo_dias: int = 30) -> Dict:
...
ASSOCIATION_REPORT_TOOLS = [
    ...
    consultar_status_estoque_associacao,
    gerar_relatorio_completo_associacao
]

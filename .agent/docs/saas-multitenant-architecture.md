...
VALUES (
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', -- UUID fixo para referência
...
UPDATE pacientes 
SET associacao_id = 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa' 
...
CREATE INDEX idx_prontuarios_associacao_paciente ON prontuarios(associacao_id, paciente_id);
```
